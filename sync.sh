...
echo "cloning device"
git clone https://github.com/phoenix-1708/android_device_xiaomi_sweet -b arrow-13.0 --depth=1 device/xiaomi/sweet
echo "cloning vendor"
git clone https://github.com/phoenix-1708/vendor_device_xiaomi_sweet -b arrow-13.0 --depth=1 vendor/xiaomi/sweet
